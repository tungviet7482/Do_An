    ...
    public partial class initialDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Job_User", x => new { x.JobId, x.UserId });
                    table.ForeignKey(
                        name: "FK_Job_User_Job_JobId",
                        column: x => x.JobId,
                        principalTable: "Job",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Job_User_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                name: "Transaction_ServicePackage",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Transaction_ServicePackage", x => new { x.TransactionId, x.ServicePackageId });
                    table.ForeignKey(
                        name: "FK_Transaction_ServicePackage_ServicePackage_ServicePackageId",
                        column: x => x.ServicePackageId,
                        principalTable: "ServicePackage",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transaction_ServicePackage_Transaction_TransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transaction_ServicePackage_ServicePackageId",
                table: "Transaction_ServicePackage",
